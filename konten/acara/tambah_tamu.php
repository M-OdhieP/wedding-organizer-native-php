...
<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Tambah Tamu</li>
			</ol>
		</nav>
<h4>Tambah Tamu</h4>
...
<td><input placeholder="Alamat" class="required form-control" type="text" name="alamat" size="50"></td>
</tr>
<tr>

<td><input placeholder="Jenis" class="required form-control" type="text" name="jenis" size="50"></td>
</tr>
<tr>

<td><input placeholder="QRCode" class="required form-control" type="text" name="qrcode" size="50"></td>
</tr>
<tr>
